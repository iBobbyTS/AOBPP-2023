...
## A. Amber Multiplayer Battle Mixed Cut Material Collection

**illustrate:**

This is a large-scale Amber-themed battle mix cut. It needs to splicing and editing Amber in-game battle video clips submitted by multiple players to make a mix cut. This work requires multiple players to complete it together.

**Submission content requirements:**

**The submitted video of Amber fighting monsters can contain any one of the following damage conditions. It is not necessary to meet all of them, but at least one appears, and the damage comes from Amber. The damage requirements that need to be included with Amber are as follows:**

	For charged arrows, deal at least 20000 damage to any monster (allows reaction and drug addiction)
	
	For physical charge, deal at least an average of 6000 damage to any monster (allows drugs and teammates to provide damage bonus)
	
	For normal attacks, the first segment of damage deals at least 5000 damage to any monster (allowing drugs and teammates to provide damage bonuses)
	
	For Baron Bunny, deal at least 20000 damage to any monster (allows reaction and drug addiction)
	
	Against Arrow Rain, deal at least an average of 3000 damage to any monster (reactions and drugs are allowed)
	
	For Plunging Attack, deal at least 10000 damage to any monster

**At the moment when the above damage is achieved, Amber must be in the foreground, and the off-hand damage (damage caused by Amber in the background) is considered invalid**

**Video material quality requirements:**
...
**The material needs to have Amber elements, the style is clear and active, and the fonts use more active fonts. If you need to draw Amber, it is better to draw cute ones**
...
**Material Quality Requirements**
	...
	Resolution should not be too low, preferably 4K
...
Submit your own items to the Amber Birthday Party. The submission requirements for ** items are relatively high, please read the requirements carefully. **

**Submission content requirements:**

	Amber birthday celebration works in the form of video, to contain many Amber elements, Amber must be the core theme of the video
	
	The content of the video is not limited, but it must be compliant and not contain bad memes
	
	The video must be an original video, and it can be produced by multiple people.
	
	Any transactions and commercial purposes involving money are strictly prohibited. This activity is entirely voluntary
	
	Do not distort Amber's character
...
**Manuscript quality requirements:**
	...
	Content meets content requirements
	
	Resolution not lower than 720P
	
	The bit rate is higher than 7Mbps, preferably 4K
...
**\*The bad meme here refers to bad memes that distort Amber's character or do not conform to the facts, such as Amber's personal attacks and character distortions, etc. Our studio is opposed to any content that uses Amber's bad memes to make people feel popular.**
...
**Amber's birthday party will be held on August 10, 2023, and will be presented in the form of simultaneous live video works on station b and Youtube. This birthday party is organized and planned by ﻿[@DaVinci2nd](https://bbs.mihoyo.com/ys/accountCenter/postList?id=291128880)﻿. Welcome to join us!**

## FAQ

This page is maintained by the anti-reconnaissance knight. If you have any questions, please use the email address: 73dejason@gmail.com
